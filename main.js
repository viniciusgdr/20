...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'porra _*OWWNER!1!1!*_',
    owner: 'o dono é o vinicius fdp!',
    mods: 'vc não é _*Moderator*_ !',
    premium: 'tens q ser _*Premium*_ !',
    group: 'tenho q ser ademir!',
    private: 'Perintah ini hanya dapat digunakan di Chat Pribadi!',
    admin: 'Perintah ini hanya untuk *Admin* grup!',
    botAdmin: 'admin please!'
  }[type]
